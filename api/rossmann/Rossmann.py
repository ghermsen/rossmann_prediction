...
class Rossmann(object):
    def __init__(self):
        self.home_path = '/media/gabriel/Pessoal/repos/projects/rossmann_prediction/'
    ...
    def data_cleaning(self, df1):
        ...
        # promo_interval
        month_map = {1:"Jan", 2:"Fev", 3:"Mar", 4:"Abr", 5:"Mai", 6:"Jun", 7:"Jul", 8:"Aug", 9:"Sep", 10:"Oct", 11:"Nov", 12:"Dec"}
    ...
    def feature_engineering(self, df2):
        ...
        # state holiday
        df2["state_holiday"] = df2["state_holiday"].apply(lambda x: "public_holiday" if x == "a" else "ester_holiday" if x == "b" else "christmas" if x == "c" else "regular_day")
